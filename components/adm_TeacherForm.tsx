...
export default function AdmTeacherForm({ defaultValues, onSubmit, onCancel }: AdmTeacherFormProps) {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (!defaultValues && !password.trim()) {
      return; // Password required for new teachers
    }
  ...
  return (
    <form onSubmit={handleSubmit} className="dark-gradient rounded-2xl p-6 border border-input">
      <h3 className="text-xl font-semibold text-primary-100 mb-4">
        {defaultValues ? "O'qituvchini tahrirlash" : "Yangi o'qituvchi qo'shish"}
      </h3>
