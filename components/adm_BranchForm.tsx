...
interface AdmBranchFormProps {
  defaultValues?: Branch;
  onSubmit: (name: string, status: "active" | "inactive") => void;
  onCancel: () => void;
}

export default function AdmBranchForm({ defaultValues, onSubmit, onCancel }: AdmBranchFormProps) {
  ...
  return (
    <form onSubmit={handleSubmit} className="dark-gradient rounded-2xl p-6 border border-input">
      <h3 className="text-xl font-semibold text-primary-100 mb-4">
        {defaultValues ? "Filialni tahrirlash" : "Yangi filial qo'shish"}
      </h3>
